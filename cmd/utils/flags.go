...
import (
	...
	"github.com/valorbit/go-ethereum/common/fdlimit"
	"github.com/valorbit/go-ethereum/consensus"
	"github.com/valorbit/go-ethereum/consensus/clique"
	"github.com/valorbit/go-ethereum/consensus/ethash"
	"github.com/valorbit/go-ethereum/core"
	"github.com/valorbit/go-ethereum/core/vm"
	"github.com/valorbit/go-ethereum/crypto"
	"github.com/valorbit/go-ethereum/eth"
	"github.com/valorbit/go-ethereum/eth/downloader"
	"github.com/valorbit/go-ethereum/eth/gasprice"
	"github.com/valorbit/go-ethereum/ethdb"
	"github.com/valorbit/go-ethereum/ethstats"
	"github.com/valorbit/go-ethereum/graphql"
	"github.com/valorbit/go-ethereum/les"
	"github.com/valorbit/go-ethereum/log"
	"github.com/valorbit/go-ethereum/metrics"
	"github.com/valorbit/go-ethereum/metrics/influxdb"
	"github.com/valorbit/go-ethereum/miner"
	"github.com/valorbit/go-ethereum/node"
	"github.com/valorbit/go-ethereum/p2p"
	"github.com/valorbit/go-ethereum/p2p/discv5"
	"github.com/valorbit/go-ethereum/p2p/enode"
	"github.com/valorbit/go-ethereum/p2p/nat"
	"github.com/valorbit/go-ethereum/p2p/netutil"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 1=Frontier, 2=Morden (disused), 3=Ropsten, 4=Rinkeby, 38=Valorbit, 138=Granville)",
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	CheckExclusive(ctx, DeveloperFlag, TestnetFlag, RinkebyFlag, GoerliFlag, ValorbitFlag, GranvilleFlag)
	...
	case ctx.GlobalBool(GranvilleFlag.Name):
		...
		setDNSDiscoveryDefaults(cfg, params.KnownDNSNetworks[params.GranvilleGenesisHash])
	case ctx.GlobalBool(DeveloperFlag.Name):
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {
			cfg.NetworkId = 1337
		}
