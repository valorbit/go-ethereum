...
import (
	...
	"github.com/valorbit/go-ethereum/consensus/misc"
...
var (
	...
	DisinflationRateQuotient = big.NewInt(11)   // Disinflation rate quotient for ECIP1017
	DisinflationRateDivisor  = big.NewInt(10)   // Disinflation rate divisor for ECIP1017
	BlockRewardGrowthEras    = big.NewInt(12)   // (Dis)inflation runs for this many eras
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/valorbit/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/valorbit/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
func accumulateEthereumRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
